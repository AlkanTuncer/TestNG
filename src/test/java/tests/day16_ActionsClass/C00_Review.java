...
public class C00_Review {
    ...
    /*
        TestBase Class : - Testlerden önce ve sonra sürekli olarak tekrarladıgımız setup ve tearDown gibi metotları her class'da yazmak yerine
                      utilities paketi altında TestBase isimli bir class olusturup oraya yazıyoruz. 'extends' keyword'ü ile yeni classlardan
                      bu class'a erişiriz.
                         - TestBase class'ı abstract yapılır, kontrolumuz dısında işlem yapılmaması için.

        WindowHandle : - Bir test esnasında birden fazla pencere acılıyorsa bu pencereler arasında geçiş yapmak için kullanılır.
                       - Kullandıgımız her sayfanın handle değerini bir String'e atamamızda fayda var.Testin ilerleyen aşamalarında bu pencerelere
                       dönmek istersek faydalı olur.
