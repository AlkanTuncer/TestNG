...
public class C04_iFrame {
    ...
    public void iFrameTest(){
        ...
        driver.switchTo().parentFrame();  //iFrame'den çıkıp bir üst siteye dönmemiz lazım ki sitenin elementini bulabilelim. En üst siteye : driver.switchTo().defaultContent();
